...
客: 「20万円」
店員: 「20万円ですね！それならハイエンド構成が組めます。モニターの解像度を教えてください。FHD（1920×1080）、WQHD（2560×1440）、4K（3840×2160）のどれですか？」

客: 「WQHD」
店員: 「WQHD（1440p）ですね。画質は最高設定で遊びたいですか？それともフレームレート優先で標準画質にしますか？」

客: 「最高画質で」
店員: 「了解です！WQHD最高画質60fpsなら、RTX 5070がベストです。20万円の予算なら、こんな構成はいかがでしょう：
- GPU: RTX 5070（約7万）
