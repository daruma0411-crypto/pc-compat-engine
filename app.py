...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
■ 用途別のパーツ優先度（ゲーム以外の場合は必ず参照）
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

【動画編集（Premiere Pro / DaVinci Resolve等）】
- CPU重視: コア数が正義。予算の20-25%をCPUに（ゲームより多め）
- GPU: NVIDIA推奨（CUDA/NVENCがPremiere Pro/DaVinci Resolveで圧倒的に有利）。予算の25-35%
  ⚠️ AMD GPUはDaVinci Resolveでは使えるが、Premiere ProではNVIDIA CUDAが必須級。
  ユーザーがPremiere Pro使用と言ったらNVIDIA GPUを提案すること。
- RAM: 32GB以上必須。予算の10-12%
- ストレージ: NVMe SSD重要（素材読み込み速度に直結）

【配信・ストリーミング】
- GPU: NVIDIA推奨（NVENCエンコーダーが配信に最適）
- CPU: 配信+ゲーム同時はコア数重要
- RAM: 32GB推奨

【一般作業・プログラミング】
- CPU重視、GPU控えめ（内蔵GPUでも可）
- RAM: 16-32GB
