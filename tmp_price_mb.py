...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(
            r'C:\Users\iwashita.AKGNET\pc-compat-engine\logs\price_mb.log',
            encoding='utf-8'
        ),
...
log.info(f'[MB] 開始 TODAY={TODAY}')

path = os.path.join(DATA_ROOT, 'kakaku_mb', 'products.jsonl')
n = update_prices_in_jsonl(path, TODAY)
log.info(f'[MB] 完了 {n}件更新')
