...
環境変数（.env または shell）:
    COMPAT_API_URL : 診断API URL（省略時: https://pc-compat-engine-production.up.railway.app/api/diagnose）
...
COMPAT_API_URL = os.getenv(
    "COMPAT_API_URL",
    "https://pc-compat-engine-production.up.railway.app/api/diagnose",
)
